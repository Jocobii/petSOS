				...
				<div class="col-lg-8 blog_section">
					<div class="card border-0">
						...
						<div class="card-body">
							...
							<a href="single.html" class="text-bl font-weight-bold blog-grid-title mt-4 mb-3">Adopta un amigo, no lo compres</a>
							<p class="card-text">“No compres, ¡adopta! Cientos de amigos esperan en calles y refugios una oportunidad”, recuerda la campaña de la asociación AnimaNaturalis, dedicada a difundir y proteger los derechos de los animales desde 2003. La amistad no tiene precio económico, según defiende esta campaña de adopciones responsables, desarrollada en España y en algunos países de Latinoamérica, como Argentina, Chile, Colombia, Ecuador y Venezuela.
                            <br>
                            <br>

                           Con un total de 150.000 perros y gatos abandonados, recogidos cada año en las calles de nuestro país, los motivos para adoptar y no comprar o criar de un modo irresponsable sobran, tal y como argumenta esta asociación.

                            Adoptar un perro o gato que lo necesita es una idea solidaria en todas las épocas del año, siempre que se realice con responsabilidad. Este aspecto es especialmente importante en Navidad, cuando los animales constituyen un regalo más.
                            <br>
                            <br>
