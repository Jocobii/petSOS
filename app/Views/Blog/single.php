		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row blog-content pt-lg-3">
				...
				<div class="col-lg-8 blog_section">
					...
					<p>Formación del comportamiento es cualquier tipo de entrenamiento que enseña a los perros a comportarse bien en torno a las personas y otros animales. Puede incluir algunos comandos básicos, pero el objetivo es hacerlos buenos ciudadanos como los perros.  </p>
					
					<p class="my-3">Parte de esta formación puede hacer frente a los problemas de comportamiento, como ladridos excesivos, masticar o allanamiento de morada .</p>
					<p>Este es un tipo muy básico de formación que sea apropiado para los perros más jóvenes que apenas están empezando.
					</p>
					<a href="single.html" class="text-bl font-weight-bold blog-grid-title mt-4 mb-3">Agilidad Formación</a>
					<div class="row">
						<div class="col-md-6">
							<p>Entrenamiento de la agilidad es para los perros que participarán en deportes caninos, como carreras de obstáculos, carreras, o saltar. Esto es definitivamente un tipo más avanzado de capacitación que ya se supone que el perro entiende comandos básicos.</p>
						</div>
						<div class="col-md-6">
							<p>El controlador no se les permite tocar ni de premiar al perro durante la competición, por lo que tendrá que haber una conexión fuerte entre el dueño y el perro a través de voz y gestos físicos. Si bien es cierto que cualquier perro puede aprender estas habilidades, algunas razas son más adecuados para estas tareas que otros.</p>
						</div>
					</div>
